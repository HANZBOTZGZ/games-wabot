...
global.Owner = {
  ...
  '6288215110575': { // put your number here
    name: 'Owner ʜᴀɴᴢ ᴏғᴄ/Creator Botz',
  ...
  '6287840949637': { // put your number here
    name: 'ʜᴀɴᴢ Creator Botz',
    isDev: false, // if true this number will send if bot have bug and developer mode true
    isReport: true, // if true this number will send if user use command /report or /join
    isCreator: false // if true this number will send if user use command /owner or /creator
  },
...
global.prems = ['6288215110787','6287840949637'] // Premium user has unlimited limit
...
// Sticker WM
global.packname = 'wa.me/6288215110787'
global.author = 'Subs Hanz OFC'
